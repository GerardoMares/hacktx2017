...
//    let URL_USER_LOGIN = "http://ec2-18-216-72-146.us-east-2.compute.amazonaws.com/v1/login.php"
    ...
    let URL_USER_REGISTER = "http://169.254.237.204:8888/v1/register.php"
    let URL_USER_LOGIN = "http://169.254.237.204:8888/v1/login.php"
    ...
    @IBAction func registerButton(_ sender: Any) {
        ...
        let parameters: Parameters=["name": nameField.text!, "email": emailField.text!, "password": passwordField.text!]
